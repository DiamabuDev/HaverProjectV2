                ...
                if (!context.NcrQas.Any())
                {
                    context.NcrQas.AddRange(
                        new NcrQa
                        {
                            ...
                            ItemId = 1,// = context.Items.FirstOrDefault(d => d.ItemId == 1).ItemId, //hard-coded
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 2,// context.ItemDefects.FirstOrDefault(d => d.ItemId == 2).ItemDefectId, //hard-coded
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 3, //context.ItemDefects.FirstOrDefault(d => d.ItemId == 3).ItemDefectId, //hard-coded
                            NcrQaProcessApplicable = false,
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 4, //context.ItemDefects.FirstOrDefault(d => d.ItemId == 4).ItemDefectId, //hard-coded
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 3, //= context.ItemDefects.FirstOrDefault(d => d.ItemId == 5).ItemDefectId, //hard-coded
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 3, //ItemDefectId = context.ItemDefects.FirstOrDefault(d => d.ItemId == 1).ItemDefectId, //hard-coded
                            NcrQaProcessApplicable = false,
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 4, ////ItemDefectId = context.ItemDefects.FirstOrDefault(d => d.ItemId == 2).ItemDefectId, //hard-coded
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 3, ////ItemDefectId = context.ItemDefects.FirstOrDefault(d => d.ItemId == 5).ItemDefectId, //hard-coded
                            NcrQaProcessApplicable = false,
                        ...
                        new NcrQa
                        {
                            ...
                            ItemId = 3, ////ItemDefectId = context.ItemDefects.FirstOrDefault(d => d.ItemId == 2).ItemDefectId, //hard-coded
